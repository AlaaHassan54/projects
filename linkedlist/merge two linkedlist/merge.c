...
/***************************************_code_***********************************/
 ...
 int count_nodes(SinglyLinkedListNode *head)
{
...
void add_at_empty(SinglyLinkedListNode **head,int data)
{
...
void add_at_end(SinglyLinkedListNode *head,int data)
{
    SinglyLinkedListNode *temp=malloc(sizeof(SinglyLinkedListNode));
    temp->data=data;
    temp->next=NULL;
...
void create_list(SinglyLinkedListNode **head,int s)
{
...
int s=count_nodes(head1)+count_nodes(head2);
