...
DoublyLinkedListNode* sortedInsert(DoublyLinkedListNode* llist, int data) {
  DoublyLinkedListNode *ptr=malloc(sizeof(DoublyLinkedListNode));
  DoublyLinkedListNode *p=llist;
  DoublyLinkedListNode *p2=NULL;
...
//empty or not ? head==null
//add at first node   p==head
//add at last node    p=null
//add in between   
