...
#define NULL 0
extern uint32_t _estack, _stext,_etext, _srodata,_erodata,_sdata,_edata,_sbss,_ebss,_sidata ;
...
static void system_intialization(void)
{
    /*intialize timer*/
}
...
void  Reset_Handler(void)
{
    uint32_t Section_Size=0,*SOURCE=NULL,*DEST=NULL;
...
/*call the system intialization system*/
system_intialization();
